/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 509cc0bb0a948418778541f8559ee3ed)
// Runtime types generated with workerd@1.20250523.0 2025-05-14 
declare namespace Cloudflare {
	interface Env {
		PUBLIC_GOOGLE_ID: string;
		GOOGLE_SECRET: string;
		MAIN: D1Database;
		Socket: Service /* entrypoint WebScoketGate from socket */;
	}
}
